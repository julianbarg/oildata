...
groups <- rbind(
  df_ma("Teppco (Group)", c("30829", "32209", "3445")),
  ...
  df_ma("Sunoco (Group)", c("18718", "12470", "39205", "39596", "7063")),
  ...
  df_ma("Tesoro (Group)", c("31570", "31583", "38933", "39013", "39029")),
  df_ma("ExxonMobil (Group)", c("4906",  "12624", "12628", "12634", "30005")),
  ...
  df_ma("HollyFrontier (Group)", c("32011", "32493", "5656",  "13161")),
  df_ma("Gensis (Group)", c("31045", "32407")),
  df_ma("Williams Field Services (Group)", c("30826", "994",   "32614")),
  df_ma("Pacific (Group)", c("31325", "31695", "31885")),
  df_ma("Valero (Group)", c("4430",  "39105", "32679", "31415", "32032")),
  df_ma("CHS (Group)", c("2170",  "9175",  "14391", "26065", "26086", "32283")),
